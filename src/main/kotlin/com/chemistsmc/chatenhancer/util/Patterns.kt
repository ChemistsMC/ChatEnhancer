...
package com.chemistsmc.chatenhancer.util

import java.util.regex.Pattern

/**
 * Commonly used regular expression patterns from the Android framework.
 *
 * It has been converted into Kotlin, and all the bits I don't need
...
object Patterns {
     ...
     */
    private const val WEB_URL_WITHOUT_PROTOCOL = ("($WORD_BOUNDARY(?<!:\\/\\/)((?:$STRICT_DOMAIN_NAME)(?:$PORT_NUMBER)?)(?:$PATH_AND_QUERY)?$WORD_BOUNDARY)")
     ...
     */
    val WEB_URL: Pattern = Pattern.compile("($WEB_URL_WITH_PROTOCOL|$WEB_URL_WITHOUT_PROTOCOL)")
}
